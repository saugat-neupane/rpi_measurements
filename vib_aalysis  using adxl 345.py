...
name_archive = input('File to open: ')#raw_input('File to open: ')
name_archive += ".txt"
...
channel_4 = extract_int_tag(data_arch, 'L4')
...
print("Amount of samples in channel 4: %s" %len(channel_4))
...
for indice in X:
    ...
    vdc_channel_4 += channel_4[indice]
    
vdc_channel_1 = vdc_channel_1 / num_data
vdc_channel_2 = vdc_channel_2 / num_data
vdc_channel_3 = vdc_channel_3 / num_data
vdc_channel_4 = vdc_channel_4 / num_data


  
print("Vdc Channel 1: {0}, Vdc Channel 2 {1}, Vdc Channel 3 {2}, Vdc Channel{3}".format(vdc_channel_1, vdc_channel_2, vdc_channel_3,vdc_channel_4))
...
for indice in X:
    ...
    channel_4[indice] -= vdc_channel_4
